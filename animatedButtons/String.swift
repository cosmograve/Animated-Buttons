...
extension String {
    ...
    static func localizedKey(_ key: String, from fileName: String? = nil) -> String {
        return NSLocalizedString(key, tableName: fileName, bundle: Bundle.main, value: key, comment: "")
    }
}
